      ...
      <section class="col-lg-12">
        <div class="box box-info">
          ...
          <div class="box-header">
            <h3 class="box-title">Transaksi Bank BSI</h3>
            <div class="btn-group pull-right">

              <p><b>Total Saldo:</b> <?php
              include '../koneksi.php';
              $no = 1;
              $data = mysqli_query($koneksi, "SELECT * FROM bank where bank_id = 1");
            ...
            <div class="table-responsive">
              <table class="table table-bordered table-striped" id="table-datatable">
                ...
                <tbody>
                  ...
                  include '../koneksi.php';
                  $no = 1;
                  $data = mysqli_query($koneksi, "SELECT * FROM transaksi, kategori WHERE kategori_id = transaksi_kategori AND transaksi_bank = 1 ORDER BY transaksi_id DESC");
                  while ($d = mysqli_fetch_array($data)) {
                  ?>
                    <tr>
